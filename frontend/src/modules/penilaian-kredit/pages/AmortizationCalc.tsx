...
export default function AmortizationCalc() {
  ...
  const columns = [
    ...
    { 
      ...
      accessor: 'interest',
      cell: (row: any) => new Intl.NumberFormat('ms-MY', { minimumFractionDigits: 2 }).format(row.profit)
    },
    { 
      header: 'Ansuran (RM)', 
      accessor: 'total',
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 space-y-4">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium text-gray-900">
                    RM {new Intl.NumberFormat('ms-MY', { minimumFractionDigits: 2 }).format(scheduleData.total_profit)}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
