      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <ResponsiveContainer width="100%" height={240}>
          <ComposedChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
            ...
            <Tooltip formatter={((v: unknown, name: unknown) => [`RM ${v}J`, name === 'disbursement' ? 'Agihan' : name]) as any} />
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <ComposedChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
              ...
              <Tooltip formatter={(v: unknown) => [`${v}%`, 'NPL']} />
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <ComposedChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
              ...
              <Tooltip formatter={(v: unknown) => [`${v}%`, 'Kutipan']} />
              <ReferenceLine x="Jul" stroke="#9CA3AF" strokeDasharray="4 4" />
